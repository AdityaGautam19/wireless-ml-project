...
![UI Screenshot](https://raw.githubusercontent.com/AdityaGautam19/wireless-ml-project/refs/heads/main/assets/screenshots/ui_screenshot.png)

📂 **Project Structure**

![Architecture Screenshot](https://raw.githubusercontent.com/AdityaGautam19/wireless-ml-project/refs/heads/main/assets/screenshots/Architecture_screenshot.png)
...
1. **Data Loading:** Load the `.pkl` dataset using Python's pickle module.  
2. **Preprocessing:** Flatten and structure the I/Q signals, encode modulation labels using LabelEncoder, and split data into training and testing sets.  
3. **Tensor Conversion:** Convert signals and labels to PyTorch tensors.  
4. **Model Definition:** Define the CNN architecture with classification and regression heads.  
5. **Training Loop:** Optimize using Adam optimizer with CrossEntropy and MSE losses combined.  
6. **Saving:** Save the trained model weights as `model.pth`.  
...
👉 [Demo Video](https://github.com/AdityaGautam19/wireless-ml-project/blob/main/assets/demo/demoUI.mp4)

*(GitHub does not support embedding video directly in README. Use the link above to view the demo.)*
